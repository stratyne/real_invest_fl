...
| 132 | absentee_owner recomputed for both counties using corrected logic. OWN_ADDR1 is mailing street for Escambia, OWN_ADDR2 for Santa Rosa -- county-specific field layout confirmed from raw data. PO Box addresses classified as absentee. _MAILING_ADDR_FIELD registry added to nal_ingest.py and compute_absentee_owner.py. SR: 16,444 absentee / 51,856 owner-occupied / 12 NULL. ESC: 35,553 absentee / 70,570 owner-occupied / 249 NULL. | 2026-06-04 |
