...
| 132 | absentee_owner recomputed for both counties using corrected logic. OWN_ADDR2 is mailing street for Santa Rosa, OWN_ADDR1 for Escambia. PO Box = absentee. EMPTY_FILTER defaulted to dor_uc=[1]. Validated against 32561 ZIP: 424 absentee / 1,742 occupied / 0 NULL. | 2026-06-04 |
